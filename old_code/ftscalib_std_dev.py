# -*- coding: utf-8 -*-
"""
Created on Fri Jun 30 10:42:15 2017
...
def get_corr_factor_std_dev(get_corr_std_dev_common_lines, std_dev_discrim):
    ...
    lines_used = get_corr_std_dev_common_lines
    ...
    for line in get_corr_std_dev_common_lines:   
        delta_sig = line[2]        
...
def calc_corr_factor(calc_corr_common_lines):
    ...
    for line in calc_corr_common_lines:
       ...
       # print delta_sig
        ...
        print line[0].line, "\t", snr, "\t", line[0].width
...
def main():
   ...
   # common_lines2 = common_lines
    ...
    lines_used, lines_rejected, corr_factor, std_dev, std_error = get_corr_factor_std_dev(cmn_lines, std_dev_discrim)
